...
public class RegisterTest {
	...
	primitiveVerify(table, new Tuple<Register>(input), new Tuple<CircuitElem>(input)); //check if the boolean logic table playes out correctly in the circuit created
    }
}
