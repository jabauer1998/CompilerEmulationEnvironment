...
public class WireVectorDeclaration extends VectorDeclaration {

    private final IdentifierList identList;

    public WireVectorDeclaration(ConstantExpression exp1, ConstantExpression exp2, IdentifierList identList) {
        super(exp1, exp2);
