...
public class VectorSlice extends Expression {
    ...
    /**
     * The VectorCall constructor takes an identifier with up to twoindex to s Ecify the sub
     ...
     * @param none
     */
    public void setExpression1(Expression index1){ this.index1 = new ConstantExpression(index1); }
     ...
     * @param none
     */
    public void setExpression2(Expression index2){ this.index2 = new ConstantExpression(index2); }
