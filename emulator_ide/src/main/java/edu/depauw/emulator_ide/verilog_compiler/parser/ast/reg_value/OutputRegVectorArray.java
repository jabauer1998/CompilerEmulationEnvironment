...
public class OutputRegVectorArray extends RegValue {
     ...
     */
    public OutputRegVectorArray(Identifier ident, ConstantExpression index1, ConstantExpression index2) {
     ...
     * @param none
     */
    public Expression getExpression1(){ return index1; }
     ...
     * @param none
     */
    public Expression getExpression2(){ return index2; }
     ...
     * @param none
     */
    public void setExpression1(Expression exp){ this.index1 = new ConstantExpression(exp); }
     ...
     * @param none
     */
    public void setExpression2(Expression exp){ this.index2 = new ConstantExpression(exp); }
