...
public class InterpreterFunctionData {
    ...
    public ModItem getFuncDeclaration(){ return functionEntry; }

    public Position getPosition(){ return this.position; }

    public void addParameter(InterpreterVariableData data){ parameterList.add(data); }

    public InterpreterVariableData getParameter(int index){ return parameterList.get(index); }
    ...
    public void restoreParameterList(){ parameterList = oldList.pop(); }

    public int numParameters(){ return parameterList.size(); }
