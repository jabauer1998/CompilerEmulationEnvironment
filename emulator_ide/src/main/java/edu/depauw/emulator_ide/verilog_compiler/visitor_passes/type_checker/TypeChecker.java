package edu.depauw.emulator_ide.verilog_compiler.visitor_passes.type_checker;
...
public class TypeChecker implements ExpressionVisitor<TypeCheckerVariableData.Type>, StatementVisitor<Void>, ModuleVisitor<Void>{
	...
	public TypeCheckerVariableData.Type visit(UnaryOperation op, Object... argv){
		...
		if (op.getOp() == edu.depauw.emulator_ide.verilog_compiler.parser.ast.expression.operation.Type.PLUS
		...
		} else if (op.getOp() == edu.depauw.emulator_ide.verilog_compiler.parser.ast.expression.operation.Type.LNEG && right == TypeCheckerVariableData.Type.STRING) {
			errorLog
				.addItem(new ErrorItem("Unexpected type for Boolean Not operation [Type -> " + right + "]", op.getPosition()));
		} else if (op.getOp() == edu.depauw.emulator_ide.verilog_compiler.parser.ast.expression.operation.Type.BNEG && (right == TypeCheckerVariableData.Type.STRING
